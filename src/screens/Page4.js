      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <Text
              allowFontScaling={false}
              style={{fontSize: 16, color: 'red', fontWeight: '800'}}>
              About location
            </Text>
          </View>
          <View
          ...
          <View
            ...
            <View
              style={{
                ...
                borderWidth: 1,
                borderColor: '#FCB439',
                backgroundColor: '#F8F8B3',
                borderRadius: 10,
              }}>
              <Text
                allowFontScaling={false}
                style={{fontSize: 12, color: '#FCB439', fontWeight: '700'}}>
                For each we prefer to submit your id online
              </Text>
            </View>
          </View>
        </View>
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Upload documents (Any Id
              </Text>
              <Text
                allowFontScaling={false}
                style={{fontSize: 13, color: GRAY, right: '18%'}}>
                Card)
              </Text>
            </View>
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  allowFontScaling={false}
                  style={{fontSize: 10, color: BLACK, left: '3%'}}>
                  Upload from device
                </Text>
              </TouchableOpacity>
            </View>
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text
                allowFontScaling={false}
                style={{color: GRAY, fontSize: 6, top: '5%'}}>
                +GST 500RS
              </Text>
            </View>
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  allowFontScaling={false}
                  style={{fontSize: 12, color: 'red', fontWeight: '900'}}>
                  Book now
                </Text>
              </TouchableOpacity>
            </View>
